...
<style> 
    ...
    <body onLoad="document.form.pnome.focus();">
        <div id="adm"><a href="listarAdministrador.php"><input type="button" name="Administrador" value="Administradores" style=" width: 120px;height: 30px;background-color: #EFEFEF;border-radius: 40px;border: 1px solid #CCC;"></a></div>
    <center>
    ...
    if (isset($_POST["pnome"])) {
        $pnome = $_POST["pnome"];
        $funcionarios = $funcionarioDAO->pesquisarFuncionarioByNome($pnome);
    } else {
