...
<script>
    ...
    <center>
            ...
            <b>
            <form action="../controller/alterarAlunoFuncionarioController.php" method="post" name="form1" enctype="multipart/form-data">
                ...
                <table id="cad_table2">
                    ...
                    <tr>
                        <td>Cpf:</td>
                        <td><input type="text" name="cpf"  onBlur="ValidarCPF(form1 .cpf);" onKeyPress="MascaraCPF(form1.cpf);" maxlength="14" value="<?php echo $aluno["cpf"] ?>" class="txt"/></td>
                    </tr>
                    <tr>
                        <td>Data Nascimento:</td>
                        <td><input type="date" name="dtnasc" value="<?php echo $aluno["datanascimento"] ?>" class="txt"/></td>
                    </tr>                
                    <tr>
                        <td>Sexo:</td>
                        <td>
                    ...
                    <tr>
                        <td>Celular:*</td>
                        <td><input type="text" name="celular" required="true" onKeyPress="fone(this)" maxlength="15"  onkeydown='return SomenteNumero(event)' value="<?php echo $aluno["celular"] ?>" class="txt"/></td>
                    </tr>
                    <tr>
                        <td>Endereco:</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                            //$funcionario["estado"];
                            echo "<select name='estado' class='txt' required='true'>";
